...
try:
    ...
    msg.warn("[HybridMultiEmbedder] voyageai not installed. Default vector will fail.")
...
try:
    ...
    msg.warn("[HybridMultiEmbedder] sentence-transformers not installed. Named vectors will fail.")
...
class HybridMultiEmbedder(Embedder):
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            "Local Model": InputConfig(
                ...
                description="Model for named vectors (concept, company, sector) - 512 tokens",
    ...
    def _get_local_model(self, model_name="paraphrase-multilingual-MiniLM-L12-v2"):
