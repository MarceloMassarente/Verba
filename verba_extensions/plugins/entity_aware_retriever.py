...
from .entity_aware_pkg.search import _execute_cascade_search, _execute_two_phase_search, _execute_two_phase_search_document_level
from .entity_aware_pkg.post_process import _apply_proximity_boost, _format_document_list_result, _process_chunks, _is_chunk_quality_good, combine_context, _rerank_with_semantic_filters
from .entity_aware_pkg.parser import _detect_entity_focus_in_query, _detect_aggregation_query, _detect_document_listing_query, _extract_group_by_from_query
from .entity_aware_pkg.filter_builder import _calculate_framework_boost, _calculate_concept_boost, _calculate_company_boost, _calculate_content_type_boost
...
class EntityAwareRetriever(Retriever):
    ...
    _execute_cascade_search = _execute_cascade_search
    _execute_two_phase_search = _execute_two_phase_search
    _execute_two_phase_search_document_level = _execute_two_phase_search_document_level
    _apply_proximity_boost = _apply_proximity_boost
    _detect_entity_focus_in_query = _detect_entity_focus_in_query
    _detect_aggregation_query = _detect_aggregation_query
    _detect_document_listing_query = _detect_document_listing_query
    _extract_group_by_from_query = _extract_group_by_from_query
    _format_document_list_result = _format_document_list_result
    _process_chunks = _process_chunks
    _is_chunk_quality_good = _is_chunk_quality_good
    combine_context = combine_context
    _calculate_framework_boost = _calculate_framework_boost
    _calculate_concept_boost = _calculate_concept_boost
    _calculate_company_boost = _calculate_company_boost
    _calculate_content_type_boost = _calculate_content_type_boost
    _rerank_with_semantic_filters = _rerank_with_semantic_filters
